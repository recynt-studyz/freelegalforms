...
const LOGO_KEY = 'flf-billofSale-logo'
const TEMPLATES_KEY = 'flf-billofSale-templates'
...
export default function BillOfSaleGenerator() {
  ...
  const getFormData = () => ({
    docType, sellerName, sellerAddress, sellerPhone, buyerName, buyerAddress, buyerPhone,
    saleDate, salePrice, paymentMethod, asIs, state, vYear, vMake, vModel, vColor, vVin, vMileage,
    propDesc, boatMake, boatModel, boatYear, boatHin, faMake, faModel, faSerial, faCalibер, brandColor,
  })
  ...
  const loadTemplate = (t: Template) => {
    ...
    if (p.docType) setDocType(p.docType)
    if (p.sellerName !== undefined) setSellerName(p.sellerName)
    if (p.sellerAddress !== undefined) setSellerAddress(p.sellerAddress)
    if (p.sellerPhone !== undefined) setSellerPhone(p.sellerPhone)
    if (p.buyerName !== undefined) setBuyerName(p.buyerName)
    if (p.buyerAddress !== undefined) setBuyerAddress(p.buyerAddress)
    if (p.buyerPhone !== undefined) setBuyerPhone(p.buyerPhone)
    if (p.saleDate) setSaleDate(p.saleDate)
    if (p.salePrice !== undefined) setSalePrice(p.salePrice)
    if (p.paymentMethod) setPaymentMethod(p.paymentMethod)
    if (p.asIs !== undefined) setAsIs(p.asIs)
    if (p.state) setState(p.state)
    if (p.vYear !== undefined) setVYear(p.vYear)
    if (p.vMake !== undefined) setVMake(p.vMake)
    if (p.vModel !== undefined) setVModel(p.vModel)
    if (p.vColor !== undefined) setVColor(p.vColor)
    if (p.vVin !== undefined) setVVin(p.vVin)
    if (p.vMileage !== undefined) setVMileage(p.vMileage)
    if (p.propDesc !== undefined) setPropDesc(p.propDesc)
    if (p.boatMake !== undefined) setBoatMake(p.boatMake)
    if (p.boatModel !== undefined) setBoatModel(p.boatModel)
    if (p.boatYear !== undefined) setBoatYear(p.boatYear)
    if (p.boatHin !== undefined) setBoatHin(p.boatHin)
    if (p.faMake !== undefined) setFaMake(p.faMake)
    if (p.faModel !== undefined) setFaModel(p.faModel)
    if (p.faSerial !== undefined) setFaSerial(p.faSerial)
    if (p.faCalibер !== undefined) setFaCalibер(p.faCalibер)
